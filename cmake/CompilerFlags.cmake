function(set_project_compile_flags project_name)
  set(KLOGG_MSVC_CLANG_CL OFF)
  if(MSVC AND CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    set(KLOGG_MSVC_CLANG_CL ON)
  endif()

  set(MSVC_FLAGS /fp:fast $<$<NOT:$<CONFIG:Debug>>:/O2>)
  if(NOT KLOGG_MSVC_CLANG_CL)
    list(APPEND MSVC_FLAGS $<$<NOT:$<CONFIG:Debug>>:/GL>)
  endif()
  if(NOT KLOGG_MSVC_CLANG_CL AND NOT (DEFINED KLOGG_TARGET_IS_ARM64 AND KLOGG_TARGET_IS_ARM64))
