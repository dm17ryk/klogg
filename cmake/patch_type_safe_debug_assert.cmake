...
set(patch_file "${PATCH_ROOT}/external/debug_assert/CMakeLists.txt")
if(NOT EXISTS "${patch_file}")
  message(FATAL_ERROR "type_safe patch: missing ${patch_file}")
endif()

file(READ "${patch_file}" content)
string(REGEX MATCH "cmake_minimum_required\\(VERSION[ ]+([0-9]+(\\.[0-9]+)*)\\)" match "${content}")
if(NOT match)
  message(FATAL_ERROR "type_safe patch: no cmake_minimum_required in ${patch_file}")
endif()
